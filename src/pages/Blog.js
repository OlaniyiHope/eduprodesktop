          ...
          <div class="container">
            <div class="row mb-10">
              <div class="col-xxl-8 col-xl-8">
                <div class="blog-list-view-wrapper">
                  <div class="row">
                      ...
                      <div class="single-blog-list mb-30">
                        ...
                        <div class="content">
                          <div class="content-main">
                            <span class="single-blog-list-category mb-15"></span>
                            <h5 class="single-blog-list-title">
                              <a href="blog-details.html">
                                Conduct a fair and accurate evaluation with Edu
                                Pro Onscreen Marking System (OSM)
                              </a>
                            </h5>
                            <p class="single-blog-list-details">
                              Every year millions of candidates appear for
                              examinations organized by assessment bodies
                              globally, handling the complex process of marking
                              answer scripts to declare time-bound results to
                              candidates...
                            </p>
                            <div class="single-blog-list-meta">
                              <span class="date">
                                <i class="fal fa-watch"></i> Jan 22, 2024
                              </span>
                            </div>
                          </div>
                          <div class="single-blog-list-author-meta">
                            <div class="meta-item-1 d-inline-block">
                              <div class="avatar-sm-info">
                                <div class="avatar-thumb">
                                  <img
                                    src="assets/img/icon/breads.png"
                                    class="blog-avatar"
                                    alt="image not found"
                                  />
                                </div>
                                <h5 class="avatar-name">
                                  Posted By: Hope Olaniyi
                                </h5>
                              </div>
                            </div>
                            <div class="meta-item-2  d-inline-block">
                              <a href="#"></a>
                            </div>
                          </div>
                        </div>
              ...
              <div class="col-xxl-4 col-xl-4">
                <div class="right-widget-area has-space widget-shadow-default pt-50 mb-40 mb-xl-0">
                  ...
                  <div class="widget mb-65">
                    <h5 class="widget-title">Recent Posts</h5>
                    <div class="rc-post-wrapper">
                      <div class="single-rc-post mb-25">
                        <div class="thumb">
                          <a href="blog-details.html">
                            <img
                              src={pro}
                        ...
                        <div class="content">
                          <h5 class="single-rc-post-title">
                            <a href="blog-details.html">
                              Conduct a fair and accurate evaluation with Edu
                              Pro Onscreen Marking System (OSM)
                            </a>
                          </h5>
                          <span class="single-rc-post-meta">Jan 22, 2024</span>
                        </div>
                      </div>
                    </div>
                  </div>
